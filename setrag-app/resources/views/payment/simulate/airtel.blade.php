...
@section('title', 'Paiement Airtel Money - SETRAG')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="card">
        <div class="text-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Paiement Airtel Money</h1>
        ...
        <form method="POST" action="{{ route('payment.simulation.airtel.process') }}" class="space-y-6">
            @csrf
