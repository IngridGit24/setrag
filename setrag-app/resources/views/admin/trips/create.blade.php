...
@section('title', 'Créer un voyage - SETRAG')
...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Créer un nouveau voyage</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.trips.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="seat_count" value="{{ old('seat_count', 100) }}" min="1" max="500" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-setrag-primary" 
                           required>
                    <p class="text-sm text-gray-500 mt-1">Nombre de sièges disponibles pour ce voyage</p>
                </div>
                ...
                <div class="md:col-span-2 border-t pt-6 mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="price_second_class" value="{{ old('price_second_class') }}" 
                                   min="0" step="100"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-setrag-primary" 
                        ...
                        <div>
                            ...
                            <input type="number" name="price_first_class" value="{{ old('price_first_class') }}" 
                                   min="0" step="100"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-setrag-primary" 
                                   placeholder="Prix par défaut">
                        ...
                        <div>
                            ...
                            <input type="number" name="price_vip" value="{{ old('price_vip') }}" 
